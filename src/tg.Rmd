```{r tgtid, cache=cacheon, fig.width=6, fig.height=5, fig.cap=paste0("Covarage 2003-", global_year, " (prevalent)/", global_year -1 , " (incident)")}
...
```{r tgmap, fig.cap=paste0("Covarage ", global_year, " (prevalent) and ", global_year -1, " (incident) by region (map)"), cache=cacheon, fig.show='hold', out.width="50%", fig.subcap=c('Prevalent', 'Incident'), fig.ncol=2}
