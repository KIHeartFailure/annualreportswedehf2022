...
```{r allki, cache=cacheon, fig.cap=paste0("Sweden, all ", nrow(qiinfo), " quality indicators ",  global_year), fig.width=9, fig.height=6}
...
axis(1,
  at = b[22],
  labels = "3-month follow-up", line = 6.1, tick = FALSE, cex.axis = cexmy, gap.axis = -10000000, las = 1
)
