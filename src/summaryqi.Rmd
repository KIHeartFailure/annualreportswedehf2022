...
```{r allki, cache=cacheon, fig.cap=paste0("Riket, alla ", nrow(qiinfo), " kvalitetsindikatorer ",  global_year), fig.width=9, fig.height=6}
...
legend("topright", levhf, fill = global_colsblue[c(2, 5)], border = global_colsblue[c(2, 5)], bty = "n", cex = cexmy)
